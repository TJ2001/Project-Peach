...
allSuperSprites["MomoSprite"].addAnimation("leftSwing", new Animation("img/Momo-Spritesheet.png",0,256,64,64,4,3));
allSuperSprites["MomoSprite"].addAnimation("rightSwing", new Animation("img/Momo-Spritesheet.png",0,192,64,64,4,3));
allSuperSprites["MomoSprite"].addAnimation("upSwing", new Animation("img/Momo-Spritesheet.png",0,128,64,64,4,3));
allSuperSprites["MomoSprite"].addAnimation("downSwing", new Animation("img/Momo-Spritesheet.png",0,448,64,64,4,3));
allSuperSprites["MomoSprite"].addAnimation("upLeftSwing", new Animation("img/Momo-Spritesheet.png",0,64,64,64,4,3));
allSuperSprites["MomoSprite"].addAnimation("upRightSwing", new Animation("img/Momo-Spritesheet.png",0,0,64,64,4,3));
allSuperSprites["MomoSprite"].addAnimation("downLeftSwing", new Animation("img/Momo-Spritesheet.png",0,384,64,64,4,3));
allSuperSprites["MomoSprite"].addAnimation("downRightSwing", new Animation("img/Momo-Spritesheet.png",0,320,64,64,4,3));
